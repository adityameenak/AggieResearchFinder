    ...
    <article className="group bg-cream-50 rounded-2xl border border-cream-300
      ...
      <div className="flex items-start justify-between gap-3 px-5 pt-5 pb-3">
        <div className="flex items-center gap-2 flex-wrap min-w-0">
          <span className="font-display font-bold text-maroon-700/40 text-[13px] flex-shrink-0 select-none">
            #{rank}
          </span>
      ...
      <div className="px-5 pt-3.5 pb-1">
        <div className="text-[10px] font-semibold text-maroon-700/70 uppercase tracking-[0.14em] mb-1.5">
          Why you match
        </div>
        <p className="text-[12.5px] text-stone-600 leading-relaxed line-clamp-3">{explanation}</p>
      </div>
      ...
      <div className="px-5 py-3 bg-cream-100/80 border-t border-cream-300 flex items-center gap-2 flex-wrap">
    ...
    <div className="bg-cream-50 rounded-2xl border border-cream-300 p-5 mb-6">
      <div className="flex items-start justify-between gap-3 mb-3">
        ...
        <button onClick={onReset}
                className="text-xs text-stone-400 hover:text-maroon-700 transition-colors font-medium whitespace-nowrap">
          Start over
        </button>
      </div>
      {themes.length > 0 && (
      ...
      {skills.length > 0 && (
        <div className="flex flex-wrap gap-1.5">
          {skills.map(s => (
            <span key={s} className="text-[11px] px-2.5 py-0.5 rounded-full bg-cream-200
                                     border border-cream-300 text-stone-600">{s}</span>
          ))}
        </div>
      )}
        ...
        {matches.length > 0 ? (
          ...
          <div className="text-center py-24">
            ...
            <button onClick={handleReset}
                    className="px-6 py-2.5 bg-maroon-700 text-cream-100 rounded-xl
